...
function syncWsPlugin(): Plugin {
  return {
    ...
    configureServer(server) {
      return attachSyncServer(server as unknown as { middlewares: { use: (...args: unknown[]) => void }; httpServer?: { on: (...args: unknown[]) => void } | null })
    },
...
function attachSyncServer(server: { middlewares: { use: (...args: unknown[]) => void }; httpServer?: { on: (...args: unknown[]) => void } | null }) {
